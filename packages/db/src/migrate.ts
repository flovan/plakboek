...
async function recordApplied(client: Client, migration: Migration): Promise<void> {
...
async function applyTransactional(client: Client, migration: Migration): Promise<void> {
...
async function applyNonTransactional(client: Client, migration: Migration): Promise<void> {
