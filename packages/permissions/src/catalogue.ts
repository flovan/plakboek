...
export const PERMISSIONS = {
  ...
  'pages:edit': {
    ...
    description: {
      ...
      message:
        'Change page content, blocks, layout, SEO fields and translations as drafts',
    },
  },
  'pages:publish': {
    group: 'pages',
  ...
  'entries:read-drafts': {
    ...
    description: {
      ...
      message:
        'See unpublished drafts, previews and revision history of entries',
    },
  },
  'entries:create': {
    group: 'entries',
  ...
  'templates:edit': {
    ...
    description: {
      ...
      message:
        "Change the shared block tree used to render a content type's detail pages",
    },
  },
  'templates:publish': {
    group: 'templates',
