 ...
 */
import { ALL_PERMISSIONS, PERMISSIONS, type Permission } from "../../src/catalogue.js";
...
const ROLE_PERMISSION_SETS: Record<(typeof ROLE_COLUMNS)[number], ReadonlySet<Permission>> = {
